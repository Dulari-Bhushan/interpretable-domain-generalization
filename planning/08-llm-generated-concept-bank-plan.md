...
|---|---|---|---|
| **Existing baseline** (Phase 0, `results/phase0_cub_reproduction.md`) | Human-written (CUB's real 311 attributes) | CLIP ViT-L/14 zero-shot similarity | `clip_cbm_orth`, DDO, 50 epochs, batch 64, lr 1e-4 |
| **New (this plan)** | **LLM-generated** (311 phrases, generated fresh from general ornithological knowledge — see §3) | CLIP ViT-L/14 zero-shot similarity (unchanged) | Identical — same architecture, same hyperparameters, same DDO |
...
- File: [`external/LanCE/data/CUB/cub_concepts_llm.txt`](../external/LanCE/data/CUB/cub_concepts_llm.txt).
